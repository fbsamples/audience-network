...
public class DebugSettings {
    ...
    public static final String INTERNAL_SETTINGS =
        "com.facebook.samples.ads.internalsettings.InternalSettings";
    ...
    public static void initialize(Application application) {
        ...
        try {
            Class internalSettings = Class.
                    forName(INTERNAL_SETTINGS);
            sExtraSettings.add(((ExtraSettings)internalSettings.newInstance()));
        } catch (Exception e) {
            // ignore missing InternalSettings
        }
