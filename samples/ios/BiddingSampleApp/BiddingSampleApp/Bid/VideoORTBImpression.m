...
#import "VideoORTBImpression.h"
#import <Foundation/Foundation.h>

NS_ASSUME_NONNULL_BEGIN
@implementation VideoORTBImpression

- (instancetype)initWith:(NSString *)impressionID
                   tagID:(NSString *)tagID
                   width:(int)width
                  height:(int)height {
    self = [[VideoORTBImpression alloc] init];
    if (self) {
...
- (instancetype)initWith:(NSString *)impressionID
    ...
    self = [[VideoORTBImpression alloc] initWith:impressionID
                                           tagID:tagID
                                           width:width
                                          height:height];
    if (self) {
...
- (NSDictionary *)impressionParameters {
    ...
    // width
    videoObject[@"w"] = @(self.width);
    // height
    videoObject[@"h"] = @(self.height);
    ...
    impObject[@"linearity"] = @(self.linearity);
    return impObject;
}
